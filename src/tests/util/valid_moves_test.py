...
def test_valid_moves_single_move():
    ...
    my_piece = piece()
    moves = valid_moves(move_set, current_position, my_piece)
    expected_output = [[2, 3]]
...
def test_valid_moves_boundaries():
    ...
    my_piece = piece()
    valid_move_set = valid_moves(move_set, current_position, my_piece)
...
def test_find_captures():
    ...
    enemy_piece = [[1, 0]]
    my_piece = piece()
    moves = valid_moves(move_set, current_position, my_piece, [], enemy_piece)
...
def test_handle_collisions():
    ...
    friendly_piece = [[4, 0]]
    my_piece = piece()
    moves = valid_moves(move_set, current_position, my_piece, friendly_piece)
    valid_move_set = moves['moves']
